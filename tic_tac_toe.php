...
function create_board($value, $id)
{
    $o = "";
    $name = "row_" . $id;
    $realValue = null;
...
//Έλεγχος νικητή
function return_winner($conditions, $response)
{
    $lr = null;
    $matches = [];
...
// Ρυθμιζουμε την συμπεριφορα του server αναλογα με το request method και τις παραμετρους
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['play'])) {
    ...
    } else if (return_winner($win_conditions, $responses)) {
        $last = $changes[0];
        $winner = null;
        if ($last == 1) {
            $winner = "X";
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="player-1" placeholder="Enter first player's name">
                </div>
                <div class="form-group">
                    <label for="player-2">Player 2 Name</label>
                    <input type="name" class="form-control" id="player-2" placeholder="Enter second player's name">
                </div>
                        ...
                        foreach ($board as $row): ?>
                            ...
                            <tr>
                                <?php foreach ($row as $tile): ?>
                                    <td>
                                        <?php echo create_board($tile, $count); ?>
                                    </td>
        ...
        <div class="col-sm-4">
            ...
            <table class="table">
                ...
                <tr>
                    <th scope="row">1</th>
                    <td>Player 1 played X move</td>
                    <td>Player 2 played O move</td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td>Player 1 played X move</td>
